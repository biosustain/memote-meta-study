...
y_axis_labels <- c(
  ...
  "test_gam_in_biomass" = "No growth-associated maintenance term in biomass reactions [Boolean]",
  ...
  "test_gene_protein_reaction_rule_presence" = "Reactions without GPR rules [fraction of total genes]",
  ...
  "test_ngam_presence" = "No non-growth associated maintenance reaction detectable [Boolean]",
