...
```{r reactionmassbalance-sorted, fig.cap='Mass Balance. Please note that any reaction where at least one metabolite lacks a formula annotation is considered as unbalanced for the purpose of this test.'}
score_plots$plot_sina[score_plots$test == "test_reaction_mass_balance"][[1]]
```

```{r orphans-sorted, fig.cap='Orphan Metabolites'}
metric_plots$plot_sina[metric_plots$test == "test_find_orphans"][[1]]
```

```{r dead-ends-sorted, fig.cap='Dead-end Metabolites'}
metric_plots$plot_sina[metric_plots$test == "test_find_deadends"][[1]]
```

```{r metaboliteannotationpresence-sorted, fig.cap='Presence of Metabolite Annotation'}
score_plots$plot_sina[score_plots$test == "test_metabolite_annotation_presence"][[1]]
```

```{r reactionannotationpresence-sorted, fig.cap='Presence of Reaction Annotation'}
score_plots$plot_sina[score_plots$test == "test_reaction_annotation_presence"][[1]]
```

```{r gene-annotation-presence-sorted, fig.cap='Presence of Gene Annotation'}
score_plots$plot_sina[score_plots$test == "test_gene_product_annotation_presence"][[1]]
```

```{r metaboliteannotationkegg-sorted, fig.cap='Metabolite KEGG.compound Annotation'}
score_plots$plot_sina[score_plots$test == "test_metabolite_annotation_overview-kegg.compound"][[1]]
```

```{r reactionannotationkegg-sorted, fig.cap='Reaction KEGG.reaction Annotation'}
score_plots$plot_sina[score_plots$test == "test_reaction_annotation_overview-kegg.reaction"][[1]]
```

```{r wrongmetaboliteannotationseed-sorted, fig.cap='Correct Metabolite SEED.compound Annotation'}
score_plots$plot_sina[score_plots$test == "test_metabolite_annotation_wrong_ids-seed.compound"][[1]]
```

```{r wrongmetaboliteannotationbigg-sorted, fig.cap='Correct Metabolite BiGG.metabolite Annotation'}
score_plots$plot_sina[score_plots$test == "test_metabolite_annotation_wrong_ids-bigg.metabolite"][[1]]
```

```{r wrongmetaboliteannotationbiocyc-sorted, fig.cap='Correct Metabolite BioCyc Annotation'}
score_plots$plot_sina[score_plots$test == "test_metabolite_annotation_wrong_ids-biocyc"][[1]]
```

```{r wrongreactionannotationbigg-sorted, fig.cap='Correct Reaction BiGG.reaction Annotation'}
score_plots$plot_sina[score_plots$test == "test_reaction_annotation_wrong_ids-bigg.reaction"][[1]]
```

```{r wrongreactionannotationbiocyc-sorted, fig.cap='Correct Reaction BioCyc Annotation'}
score_plots$plot_sina[score_plots$test == "test_reaction_annotation_wrong_ids-biocyc"][[1]]
```

```{r wrongmetaboliteannotationhmdb-sorted, fig.cap='Correct Metabolite HMDB Annotation'}
score_plots$plot_sina[score_plots$test == "test_metabolite_annotation_wrong_ids-hmdb"][[1]]
```

```{r wrongreactionannotationec-sorted, fig.cap='Correct Reaction Enzyme Classification Annotation'}
score_plots$plot_sina[score_plots$test == "test_reaction_annotation_wrong_ids-ec-code"][[1]]
```

```{r reactionannotationmetanetx-sorted, fig.cap='Reaction MetaNetX.reaction Annotation'}
