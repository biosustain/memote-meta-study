...
dplyr::tibble(
  collection = factor(
    c("agora", "carveme", "path", "kbase", "bigg", "ebrahim", "uminho"),
    levels = c("agora", "carveme", "path", "kbase", "bigg", "ebrahim", "uminho")
  ),
  name = c(
    "AGORA",
    "CarveMe",
...
```{r umap, fig.cap='Depicted are the distances between models in higher order space given by the normalized test features reduced to two dimensions using t-SNE.', cache=TRUE, dependson='load'}
